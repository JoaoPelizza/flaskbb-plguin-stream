...
update-translations:
	pybabel extract -F babel.cfg -k lazy_gettext -o stream/translations/messages.pot .
	pybabel update -i stream/translations/messages.pot -d stream/translations/

add-translation:
	@read -p "Enter new language shortcode:" lang; \
	pybabel init -i stream/translations/messages.pot -d stream/translations/ -l $$lang

compile-translations:
	pybabel compile -d stream/translations/
